  ...
  return (
    <>
      ...
      <div className="conta1">
        ...
        <div className="beanstext2">Beans that provides great taste</div>
        ...
        <div className="coffee-cuptext2">Coffee like you have never tasted</div>
        <img className="price" src="./assets/images/price.png" alt="" />
        <div className="pricetext1">Affordable Price</div>
        <div className="pricetext2">Our Coffee prices are easy to afford</div>
        <div className="idea4">
          <div className="idea0">
            <div className="idea">
